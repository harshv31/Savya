...
export const metadata: Metadata = {
  title: 'New Arrivals',
  description: 'The latest handcrafted additions to the Savya collection.',
};
  ...
  return (
    <div>
      <PageHeader
        eyebrow="Just Landed"
        title="New Arrivals"
        description="The latest pieces to leave our atelier — sculptural, considered, and made to order."
